...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Prices, [{
    ...
    value: function render() {
      ...
      if (this.state.currency === 'USD') {} else if (this.state.currency === 'INR') {} else if (this.state.currency === 'USD') return __jsx("div", {
        __source: {
...
//# sourceMappingURL=index.js.32c864a4ef2dc17cedec.hot-update.js.map